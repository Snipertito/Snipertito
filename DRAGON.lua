...
if text == "اطردني" and ChCheck(msg) or text == "طلعني" and ChCheck(msg) then
if Queenx:get(Queen.."Abs:Kick:Me"..msg.chat_id_) then
Queenx1(msg.chat_id_, msg.id_, 1, '◍عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
Queenx:set(Queen..'yes'..msg.sender_user_id_..'', 'delyes')
Queenx:set(Queen..'no'..msg.sender_user_id_..'', 'delno')
