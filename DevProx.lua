...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DevProx.lua', '⌁︙نسخة ملف سورس ايفل',dl_cb, nil)
end end
--     Source DevProx     --
...
os.execute('wget https://raw.githubusercontent.com/Snipertito/tito/master/DevProx.lua') 
dofile('DevProx.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/Snipertito/titoFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/Snipertito/titoFiles/master/DevProxFiles/"..FileName)
if Res == 200 then
