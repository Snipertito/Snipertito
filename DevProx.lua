...
--   This Is The Source Channel @SourceEval .   --
--                - DevProx -                 --
--        -- https://t.me/SourceEval --         --
------------------------------------------------ 
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'ايفل')
--     ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ     --
...
local UserName = (dp.username_ or "SourceEval")
...
⌁︙م6 ↫ اوامر الاعضاء
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Source Channel](https://t.me/SourceEval)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "ايفل")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "ايفل")..' ','')
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceEval')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'SourceEval')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "SourceEval")..')', 1, 'md') 
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@SourceEval]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@SourceEval]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ     --
--        Contact         --
...
local BotName = (DevAbs:get(DevProx.."Abs:NameBot") or 'ايفل')
...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'ايفل')
local DevProxTEAM = {"انت اعمي يسطا اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." يساتر يارب عايز اي يعم 😒🔪","انت البوت لك 😒💔"} 
...
if text and text == (DevAbs:get(DevProx..'Abs:NameBot') or 'ايفل') then 
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'ايفل')
...
⌁︙[Exp Source](https://t.me/SourceEval)

⌁︙[Developer](https://t.me/e2_c11)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws DevProx](https://t.me/Xccppbot)
]]
...
local DevProxTEAM = "حاضر يقلبي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
...
local DevProxTEAM = "حاضر يقلبي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md') 
local DevProxTEAM = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","انت يكس يكسمك ي قله عمك لا فاهم.😖👌🏿","امشي وخلي يومك يعدي يسطا.😏🖕🏿","طب وبعدين في كسمك بقا هتفضل تضايق عمك لي 😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
...
{{text = '⌁ DevProx TeAM .',url="t.me/SourceEval"}},
}
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/SourceEval' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "SourceEval")..")"
else 
...
os.execute('wget https://raw.githubusercontent.com/Snipertito/Snipertito/master/DevProx.lua') 
dofile('DevProx.lua') 
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/Snipertito/SnipertitoFiles/master/DevProxFiles/"..FileName)
if Res == 200 then
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@SourceEval]', 1, 'md')    
end 
--     ՏΌႮᎡᏟᎬ ᎬᏙᎪᏞ     --
